...
Converter::Converter(std::string inputFileName, std::string outputFileName, bool progress) :
...
//     writeHdf5Attribute(outputGroup, "HDF5_CONVERTER_VERSION", std::string(HDF5_CONVERTER_VERSION));
    ...
    for (int i = 1; i <= numAttributes; i++) {
        ...
        if (attributeName.empty() || attributeName.find("COMMENT") == 0 || attributeName.find("HISTORY") == 0) {
            ...
            if (H5outputfile.exists_attribute(parentpath, attributeName)) {
...
//                     writeHdf5Attribute(outputGroup, attributeName, attributeValueStr);
                    H5outputfile.write_attribute(parentpath, attributeName, attributeValueStr);
...
//                     writeHdf5Attribute(outputGroup, attributeName, attributeValueBool);
                    H5outputfile.write_attribute(parentpath, attributeName, attributeValueBool);
...
//                         writeHdf5Attribute(outputGroup, attributeName, attributeValueDouble);
                        H5outputfile.write_attribute(parentpath, attributeName, attributeValueDouble);
...
//                         writeHdf5Attribute(outputGroup, attributeName, attributeValueInt);
                        H5outputfile.write_attribute(parentpath, attributeName, attributeValueInt);
                    } catch (const std::invalid_argument& ia) {
...
//                     writeHdf5Attribute(outputGroup, attributeName, attributeValue);
                    H5outputfile.write_attribute(parentpath, attributeName, attributeValue);
                }
            }
        }
    }
